 ...
 *| yield_2_text_998=="Avas" | yield_2_text_998=="Haba" | yield_2_text_998=="Habas"
 
 clonevar yield_2_44_1 = yield_2_44 
 replace yield_2_44_1 =1 if yield_2_habas ==1
 
 replace yield_2_997_1=0 if yield_2_997_1==1 & yield_2_44_1 ==1
 ...
 *|  yield_2_text_998 =="Rabanito" |  yield_2_text_998 =="Rabano" | yield_2_text_998 =="Rabano," | yield_2_text_998 =="Rabanos"
 }
 
 
clonevar yield_2_42_1 = yield_2_42 
 replace yield_2_42_1 = 1 if yield_2_radish ==1
 ...
 *=======================================
 ...
 replace yield_2_1_1 = 1 if yield_2_acelga ==1
 ...
 *| yield_2_text_998 =="Banano" | yield_2_text_998 =="Bananos"
 }
 ...
 replace  yield_2_48_1 = 1 if yield_2_banana ==1
 ...
 replace yield_2_aguacate=1 if yield_2_aguacate1 ==1 & yield_2_997_1==1 | yield_2_aguacate2 ==1 & yield_2_998_1==1 | yield_2_aguacate3 ==1 & yield_2_999_1==1
 ...
 *| yield_2_text_998 =="Brócoli" 
 }
 
 clonevar yield_2_6_1 = yield_2_6 
  replace yield_2_6_1 = 1 if yield_2_brocoli ==1
 ...
 *| yield_2_text_998 =="Remolachas" | yield_2_text_998 =="Remolacha"
 } 
 
clonevar  yield_2_49_1 =  yield_2_49 
  replace yield_2_49_1 = 1 if yield_2_beetroot ==1
 ...
 * ========================================
 ...
 foreach i of local is {
 gen yield_2_`i' = . 
 replace yield_2_`i' = 1 if yield_2_text_997 =="Cafe" | yield_2_text_997 =="Cafe,guineo" | yield_2_text_997 =="Café"  | yield_2_text_997 =="Café Robusto"
 * | yield_2_text_998 =="Cafe" | yield_2_text_998 =="Café"
 } 
 
clonevar yield_2_47_1 = yield_2_47 
 replace yield_2_47_1  =1 if yield_2_coffee ==1
 ...
 * ========================================
 ...
 replace yield_2_46_1 =0  if yield_2_chipilin ==1
 ...
 *| yield_2_text_998 =="Coliflor" | yield_2_text_998 =="Colifrol" | yield_2_text_998 =="Colifror"
 } 
 
 clonevar yield_2_45_1 = yield_2_45
 replace yield_2_997_1 = 1 if yield_2_cauliflower ==1
 ...
 *| yield_2_text_998 =="Coliflor" | yield_2_text_998 =="Colifrol" | yield_2_text_998 =="Colifror"
 ...
 replace yield_2_997_1 = 1 if yield_2_lettuce ==1
 replace yield_2_997_1 = 0 if yield_2_997_1 ==1 & yield_2_997_1==1 
...
* ============================================ 
 ...
 foreach i of local is {
 gen yield_2_`i' = 0 if  consent !=1
 replace yield_2_`i' = 1 if yield_2_text_999 =="Aguacate" 
...
* ============================================== 
 ...
 replace yield_2_997_1 =0 if yield_2_alverja ==1 & yield_2_997_1==1 
 ...
 *| yield_2_text_998 =="Chile" | yield_2_text_998 =="Chile Jalapeño" | yield_2_text_998 =="Chile chiltepe" | yield_2_text_998 =="Chile chocolate" | yield_2_text_998 =="Chile jalapeño" | yield_2_text_998 =="Chile picante" | yield_2_text_998 =="Chile pimiento" 
 }
 
 replace yield_2_997_1 =0 if yield_2_chile ==1 & yield_2_997_1==1 
 ...
 *============================================================================
 ...
 replace yield_2_997_1 =0 if yield_2_cacao ==1 & yield_2_997_1==1 
 
 *============================================================================
 
 * Ejote 
 local is ejote // ejote
 foreach i of local is {
 gen yield_2_`i' = 0 if  consent !=1
 replace yield_2_`i' = 1 if yield_2_text_997 =="Ejote" | yield_2_text_997 =="Ejotes" 
 }
 replace yield_2_997_1 =0 if yield_2_ejote ==1 & yield_2_997_1==1 
 
 * ===========================================================================
 
  * hierbamora 
 local is hierbamora // hierbamora
 foreach i of local is {
 gen yield_2_`i' = 0 if  consent !=1
 replace yield_2_`i' = 1 if yield_2_text_997 =="Hierba  mora" | yield_2_text_997 =="Hierba Mora" | yield_2_text_997 =="Hierba mora" | yield_2_text_997 =="Hierbamora" | yield_2_text_997 =="Hierva mora" | yield_2_text_997 =="Llerba mora" | yield_2_text_997 =="Llerba mora o yerba mora" | yield_2_text_997 =="Llervamora" | yield_2_text_997 =="Yerba Mora" | yield_2_text_997 =="Yerba mora" | yield_2_text_997 =="Yerbamora" | yield_2_text_997 =="Durazno, Hierba Mora" 
 }
 replace yield_2_997_1 =0 if yield_2_hierbamora ==1 & yield_2_997_1==1 
 
 * ============================================================================
 * Nabos
  local is nabos // nabos
 foreach i of local is {
 gen yield_2_`i' = 0 if  consent !=1
 replace yield_2_`i' = 1 if yield_2_text_997 =="NAVOS" | yield_2_text_997 =="Nabo" | yield_2_text_997 =="Nabo blanco" | yield_2_text_997 =="Nabo cabezon" | yield_2_text_997 =="Nabos" | yield_2_text_997 =="Naco blanco" | yield_2_text_997 =="Navo" 
 }
 
  replace yield_2_997_1 =0 if yield_2_nabos ==1 & yield_2_997_1==1 
  
  
* ============================================================================
 * Guisquil
  local is guisquil // Guisquil
 foreach i of local is {
 gen yield_2_`i' = 0 if  consent !=1
 replace yield_2_`i' = 1 if yield_2_text_997 =="Guisquil" | yield_2_text_997 =="Guisquil es" | yield_2_text_997 =="Guisquiles" | yield_2_text_997 =="Guusquil" | yield_2_text_997 =="Güisquil" | yield_2_text_997 == "Wisquil" | yield_2_text_997 == "Limón, guisquil"
  ...
  replace yield_2_997_1 =0 if yield_2_guisquil ==1 & yield_2_997_1==1 
 
* ===========================================================================

* maxan
  local is maxan // hoja de mashan
 foreach i of local is {
 gen yield_2_`i' = 0 if  consent !=1
 replace yield_2_`i' = 1 if yield_2_text_997 =="Hoja de mashan" | yield_2_text_997 =="Hoja machan" | yield_2_text_997 =="Hojas de Mashan" | yield_2_text_997 =="Hojas de machan" | yield_2_text_997 =="Hojas de mashan" | yield_2_text_997 == "Hojas de mashan para envolver tamales" | yield_2_text_997 == "Hojas mashan" | yield_2_text_997 =="Hojas para tamal" | yield_2_text_997 =="Mashan"
  ...
  replace yield_2_997_1 =0 if yield_2_maxan ==1 & yield_2_997_1==1 
  
* ===========================================================================

* duraznos
  local is durazno // hoja de mashan
 foreach i of local is {
 gen yield_2_`i' = 0 if consent !=1
 replace yield_2_`i' = 1 if yield_2_text_997 =="Durasnos" | yield_2_text_997 =="Durazno" | yield_2_text_997 =="Durazno y elote" | yield_2_text_997 =="Durazno y manzana" | yield_2_text_997 =="Durazno, Hierba Mora" | yield_2_text_997 == "Hojas de mashan para envolver tamales" 
 }
 
  replace yield_2_997_1 =0 if yield_2_durazno ==1 & yield_2_997_1==1 
